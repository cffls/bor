...
func TestMVHashMapOverwrite(t *testing.T) {
	...
	// Tx1 delete
	for _, v := range states[1].writeList {
		mvhm.Delete(v.Path, 1)
	}

	states[1].writeList = nil
	states[1].writeIndex = nil
	...
	// Tx0 delete
	for _, v := range states[0].writeList {
		mvhm.Delete(v.Path, 0)
	}

	states[0].writeList = nil
	states[0].writeIndex = nil
...
func TestMVHashMapWriteNoConflict(t *testing.T) {
	...
	// Tx2 delete
	for _, v := range states[2].writeList {
		mvhm.Delete(v.Path, 2)
	}

	states[2].writeList = nil
	states[2].writeIndex = nil
